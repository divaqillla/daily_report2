      ...
      <form action="<?= site_url('finishing/update/' . $finishing['id']) ?>" method="post">
        ...
        <div class="form-group row">
          <div class="col-md-6">
            ...
            <input type="text" name="diameter" class="form-control" value="<?= $finishing['diameter'] ?>" required>
          </div>
          <div class="col-md-6">
        ...
        <div class="form-group row">
          <div class="col-md-6">
            ...
            <input type="number" name="qty" class="form-control" value="<?= $finishing['qty'] ?>" required>
          </div>
          <div class="col-md-6">
            <label>Remarks</label>
