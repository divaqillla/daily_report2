                ...
                <div class="tab-content" id="stepWizardContent">
                        ...
                        <div class="segment">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-input">
                                    ...
                                    <tbody>
                                        <?php 
                                        // Daftar default untuk partlist dan material (sesuaikan jika diperlukan)
                                        $defaultPoly = [
                                            [
                                        ...
                                        // Jika data poly dari database ada
                                        if (!empty($poly) && is_array($poly)) : 
                                            ...
                                            // Jika jumlah data poly kurang dari default (misal, kurang dari 2), tambahkan baris default
                                            $existingCount = count($poly);
                                            for ($j = $existingCount; $j < count($defaultPoly); $j++): 
                                                $no = $j + 1; // penomoran dimulai dari 1
                                            ...
                                            // Jika data poly kosong, tampilkan seluruh default baris
                                ...
                                <table class="table table-bordered table-input" id="mainMaterialTable">
                                    ...
                                    <tbody>
                                        ...
                                        if (strpos($part, 'LOWER') !== false && $part !== 'BACKUP INSERT LOWER') {
                                            $materialSpec = $ppsDies['lower']; // Use the actual lower material value from $ppsDies
                                        } elseif (strpos($part, 'UPPER') !== false && $part !== 'BACKUP INSERT UPPER') {
                                            $materialSpec = $ppsDies['upper']; // Use the actual upper material value from $ppsDies
                                        } else {
                                            $materialSpec = ''; // For other parts
                                        }
                                ...
                                <table class="table table-bordered table-input" id="machiningTable2">
                                    ...
                                    <tbody>
                                        ...
                                        foreach($processes as $index => $proc): 
                                            ...
                                            // Tentukan default value berdasarkan baris
                                    ...
                                    <tbody>
                                        <?php if (isset($finishing) && is_array($finishing) && count($finishing) > 0): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" name="finishing_qty[]" class="form-control" value="<?= esc($row['qty'] ?? '') ?>" >
                                                </td>
                                                <td>
                    ...
                    <div class="tab-pane fade" id="step9" role="tabpanel">
                        <div class="segment">
                            ...
                            <?php 
                                $dieSpotProcess = [
                                    ['DIE SPOTTING', '', '32'], // kolom mesin dikosongkan agar default null
                                    ['TRY OUT', '', '32']
                                ];
                                    ...
                                    <tbody>
                                        <?php if(isset($tool_cost) && is_array($tool_cost) && count($tool_cost) > 0): ?>
                                            ...
                                            <tr>
                                                <td class="row-number"><?= $i + 1 ?></td>
                                                <td>
                                                    <!-- Sesuaikan nama field yang sesuai dengan tabel cutting_tools -->
...
// Panggil fungsi untuk sp_part_list dan sp_material_spec
...
<!-- Script jQuery untuk dynamic row dan perhitungan otomatis -->
<script src="https://code.jquery.com/jquery-3.5.1.min.js"></script>
<script>
...
<script>
    ...
    // Rows to include in the sum (array indices start from 0)
    const defaultRowsToSum = [1, 2, 3, 4, 5, 6, 8]; 
    
    // Rows to exclude from the sum
    const excludeRows = [7, 9, 10, 11, 12, 13, 14];
    
    // Function to update total lead time
    function updateTotalLeadTime() {
        let total = 0;
        
        leadTimeInputs.forEach((input, index) => {
            // Add to total only if the row should be included in sum
    ...
    // Set default values based on initial calculation and add event listeners
    leadTimeInputs.forEach((input, index) => {
        ...
        // Add event listener to inputs that should be included in the sum
...
// Trigger otomatis saat user mengisi L, W, atau H
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    inputs.forEach(function(input) {
        ...
        // Add event listener to update class if the value changes
