...
.dcp-slider-container {
  ...
  padding: 10px 40px; /* beri ruang agar tombol tidak menimpa gambar */
  width: 100%;
        ...
        <div class="step active" data-step="1">
          ...
          <div class="card p-3 mb-3">
            ...
            <div class="row">
              ...
              <!-- Tambahkan ini di bawah select dropdown part_no -->
              <input type="hidden" id="part_no" name="part_no">

              </div>
              <div class="col-md-6 mb-3">
                <label>Part Name <span style="color: red">*</span></label>
                <input type="text" id="part_name" name="part_name" class="form-control" required readonly>
              </div>
            </div>
          </div>
          ...
          <div class="card p-3 mb-3">
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" id="cust" name="cust" class="form-control" required readonly>
                <!-- Container untuk suggestion cust -->
                <div id="cust-suggestions" class="suggestions-dropdown" style="display: none;"></div>
              </div>
              <div class="col-md-6 mb-3">
                <label>Model <span class="text-danger">*</span></label>
                <input type="text" id="model" name="model" class="form-control" required readonly>
              </div>
              <div class="col-md-6 mb-3">
                <label>Receive</label>
      ...
      <div class="step" data-step="2" style="display: none;">
        ...
        <div class="card p-3 mb-3">
          ...
          <div class="col-md-4 mb-3">
            ...
            <select id="materialDropdown" class="form-control custom-select2 mb-2" style="width: 100%; height: 38px;"><span style="color: red">*</span>
        ...
        <!-- <div class="card p-3 mb-3">
          ...
          <div class="row">
            ...
            <div class="col-md-4 mb-3">
              <label>BQ</label>
              <input type="number" id="boq" name="boq" class="form-control" min=0>
            </div>
          </div>
          <div class="row">
            <div class="col-md-4 mb-3">
      ...
      <div class="modal fade" id="materialHintModal" tabindex="-1" role="dialog" aria-labelledby="materialHintModalLabel" aria-hidden="true">
                  ...
                  <table class="table table-bordered">
                      <thead>
                          <tr>
                              ...
                              <th width="11%">Estimasi Part (p dan l)</th>
                              <!-- <th width="8%">Estimasi Part (l)</th> -->
        ...
        <div class="step" data-step="4" style="display: none;">
          ...
          <div class="card p-3 mb-3">
            ...
            <li>Die Cons Image : Silahkan pilih gambar atau upload gambar apabila tidak ada di dalam list gambar</li>
          ...
          <div class="card p-3 mb-3">
            <div class="row">
              <div class="col-md-12 mb-3">
                ...
                <li>List Gambar yang tampil akan sesuai dengan bedasarkan OP Maksimum yang Anda pilih</li>
  ...
  el.addEventListener('change', function() {
   ...
   // … di dalam event change handler, setelah dapat imgList & imgHidden …
    ...
    var qty = document.createElement('td');
      ...
      var panjangLebar = document.createElement('td'); // satu <td>
// Create container div for better layout control
var container = document.createElement('div');
container.style.width = '100%';

// First row: Panjang and Lebar inline
...
inputPanjang.style.width = '48%';
inputPanjang.style.marginRight = '4%';
...
inputPanjang.addEventListener('input', function(){
  ...
  // 4) update dropdown DC Process, lalu hitung die weight
...
// Add panjang and lebar to first row
firstRow.appendChild(inputPanjang);
firstRow.appendChild(inputLebar);

// Second row: PanjangProses on its own line
...
// Third row: Diameter and JumlahPie inline
...
inputDiameter.style.width = '48%';
inputDiameter.style.marginRight = '4%';
inputDiameter.readOnly = true; // tambahkan readonly
...
inputJumlahPie.style.width = '48%';
inputJumlahPie.readOnly = true; // tambahkan readonly
inputJumlahPie.addEventListener('input', function(){
  // 1) hitung luas
  calculateLuas(this);
});

// Add diameter and jumlahPie to third row
...
basicRow.appendChild(panjangLebar);
      ...
      selectMachine.addEventListener('change', function() {
        ...
        hitungDieWeight(selectMachine); // dipanggil setelah proses selesai
        generateDieConstructionTable();
    });
...
function calculateLuas(element) {
    ...
    // Ambil hidden proses dan proses_gang
    var proses = row.querySelector('input[name="proses[]"]')?.value || '';
    var prosesGang = row.querySelector('input[name="proses_gang[]"]')?.value || '';

    var luas = 0;
    console.log("p1", proses);
    if (proses.includes("PIE") || prosesGang.includes("PIE")) {
      console.log("p2", proses);
        luas = 3.14 * diameterValue * jumlahPieValue;
    } else if (panjangProsesValue > 0) {
        // Jika panjang proses diisi
        luas = 2 * panjangProsesValue + 2 * lebarValue;
        console.log("p3", proses);
    } else {
        // Default
        luas = 2 * panjangValue + 2 * lebarValue;
        console.log("p4", proses);
    }
...
function togglePieInputsEditable(row) {
    ...
    if ((proses.includes("PIE") || prosesGang.includes("PIE")) && inputDiameter && inputJumlahPie) {
    ...
    // Pad (dropdown)
    tr.appendChild(createDropdown("pad[]", ["FCD55", "S45C", "SKD11", "HMD5", "SXACE"], padValue));
    // Pad Lifter (dropdown)
...
console.log(
  ...
  function calculateDieWeight3(element) {
    ...
    console.log("Clicked row:", dieTableRow);

    var dieTableRows = document.querySelectorAll("#dieTableBody tr");
    console.log("All rows:", dieTableRows);
  ...
  function hitungDieWeight(sel) {
    ...
    // ambil proses akhir dari basicRow (input[name="proses[]"]) <<<  
    var prosesVal = basicRow.querySelector('input[name="proses[]"]').value.toLowerCase();

    // tentukan factor sesuai kondisi
    var factor = 1;
  ...
  function fetchMachineData() {
    ...
    for (var i = 0; i < totalRows; i++) {
      ...
      if (isNaN(mainPressureValue) || mainPressureValue <= 10) {
            Swal.fire({
                icon: 'warning',
                title: 'Main Pressure Tidak Valid!',
                text: 'Nilai Main Pressure harus lebih dari 10 pada baris ke-' + (i + 1),
                confirmButtonText: 'OK'
            });
            return;
        }
    ...
    .then(data => {
      ...
      if (data.error) {
        ...
        for (var i = 0; i < machineSelects.length; i++) {
          ...
          console.log("segement 2");
          generateDieConstructionTable(); 
        }

        console.log("segement 3");
  ...
  .then(data => {
    ...
    if (data.error) {
      ...
      if (currentRow) {
        ...
        var dieWidthInput  = currentRow.cells[3].querySelector('input[name="die_width[]"]');
