                        ...
                        <div class="tab-content" id="stepWizardContent">
                            ...
                            <div class="tab-pane fade show active" id="step1" role="tabpanel">
                                <div class="segment">
                                    ...
                                    <!-- CF Dimension dipecah jadi 3 input inline: Length, Width, Height -->
                                ...
                                <script>
                                    $(document).ready(function() {
                                        // Inisialisasi Select2 (jika belum diinisialisasi otomatis)
                                        $('#part_no_select').select2();

                                        // Ketika option dipilih
                                    ...
                                    fetch(baseUrl + '/ccf/lead-time/' + encodeURIComponent(cls))
                                        ...
                                        .then(data => {
                                            ...
                                            // Cek setiap baris machining_process dan isi machining_working_time sesuai kategori
                                            ...
                                            processInputs.forEach((procInput, index) => {
                                                ...
                                                // Set value ke kolom machining_working_time
                                                if (timeInputs[index]) {
                                                    timeInputs[index].value = time;

                                                    // Tambahkan class warna jika ingin efek visual
                            ...
                            <div class="tab-pane fade" id="step4" role="tabpanel">
                                <div class="segment">
                                    ...
                                    <table class="table table-bordered table-input" id="mainMaterialTable">
                                        ...
                                        <tbody>
                                            <?php foreach ($ccf_master_main_material as $index => $material): ?>
                                                <tr>
                                        ...
                                        <table class="table table-bordered table-input" id="standardPartTable">
                                            ...
                                            <tbody>
                                                <?php if (!empty($ccf_master_standard_part)): ?>
                                                    <?php foreach ($ccf_master_standard_part as $index => $part): ?>
                                                    <tr>
                                                        <td class="row-number"><?= $index + 1 ?></td>
                                                        <td>
                                        ...
                                        <table class="table table-bordered table-input" id="dieSpotTable3">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="row-number">   <?= $i++ +1?></td>
                                                    <td>
                                                        <input type="text" name="die_spot_process[]" class="form-control" value="<?= $proc ?>" >
                                                    </td>
...
// Hitung berat semua baris saat dokumen siap
$(document).ready(function () {
