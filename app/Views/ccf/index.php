                    ...
                    <?php if (count($items) > 1): ?>
                      ...
                      <?php else: ?>
                        ...
                        <?php if ($first['status'] == 1): ?>
                            <a href="<?= base_url('ccf/delete/' . $first['id']) ?>" class="btn btn-danger mr-1 mb-1 btn-delete" data-toggle="tooltip" title="Delete Data">
                                <i class="fa fa-trash"></i> Delete
                            </a>
                        <?php elseif ($first['status'] == 0): ?>
                            <a href="<?= base_url('ccf/rollback/' . $first['id']) ?>" class="btn btn-light mr-1 mb-1 btn-rollback" data-toggle="tooltip" title="Rollback Data">
