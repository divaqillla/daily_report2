                                        ...
                                        <table class="table table-bordered table-input" id="dieSpotTable2">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="row-number"><?= $index + 1 ?></td>
                                                    <td>
                                                        <input type="text" class="form-control" name="die_spot_process[]" value="<?= esc($row['die_spot_process']) ?>">
                                                    </td>
                                                    <td>
                                        ...
                                        <table class="table table-bordered table-input" id="dieSpotTable3">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="row-number"><?= $index + 1 ?></td>
                                                    <td>
                                                        <input type="text" name="die_spot_process[]" class="form-control" value="<?= esc($row['die_spot_process']) ?>">
                                                    </td>
                                                    <td>
