                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select2 form-control text-uppercase" name="class" id="classSelect" onchange="updateUkuranPart()">
                                                    ...
                                                    <option value="<?= $class ?>" <?= ($class == $jcp['class']) ? 'selected' : '' ?>><?= $class ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                        <!-- <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="ukuran_part" id="ukuranPart" value="<?= $jcp['ukuran_part'] ?>" readonly>
                                            </div>
                                        </div> -->
                                    </div>
    ...
    <div class="segment">
        ...
        <div class="table-responsive mt-3">
            <table class="table table-bordered table-input" id="dieSpotTable3">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="row-number"><?= $index + 1 ?></td>
                        <td><input type="text" name="die_spot_process2[]" class="form-control" value="<?= esc($row['die_spot_process2']) ?>"></td>
        ...
        <script>
            ...
            function updateUkuranPart() {
                ...
                fetch('/jcp/lead-time/' + encodeURIComponent(cls))
                    .then(r => r.json())
                    .then(data => {
