                        ...
                        <div class="tab-content" id="stepWizardContent">
                            ...
                            <div class="tab-pane fade show active" id="step1" role="tabpanel">
                                <div class="segment">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Jig Dimension (L × W × H)</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="ukuran_part" id="ukuranPart" >
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <script>
                                    ...
                                    function updateUkuranPart() {
                                        ...
                                        fetch(baseUrl + '/jcp/lead-time/' + encodeURIComponent(cls))
                                            .then(r => r.json())
                                            .then(data => {
                                                // Designing
                            ...
                            <div class="tab-pane fade" id="step9" role="tabpanel">
                                <div class="segment">
                                    ...
                                    <?php 
                                        $dieSpotProcess = [
                                            ['PROJECTION NUT', 'WSS NUT WELD', ''], // kolom mesin dikosongkan agar default null
                                        ...
                                        <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="number" name="aksesoris_qty[]" class="form-control" value="1">
                                                    </td>
                                                    <td>
                                                        <button type="button" class="btn btn-danger btn-sm removeRow">Hapus</button>
                                                    </td>
...
function hitungBerat($row) {
    ...
    let partList = $row.find('.mm-part-list').val().trim().toLowerCase(); // Ambil nilai part list
