    ...
    <div class="card-box p-4">
      <form action="<?= site_url('outdoor-activity/update/'.$activity['id']); ?>" method="post">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <!-- Dropdown diubah menjadi disabled -->
            ...
            <!-- Input hidden untuk mengirimkan nilai user_id -->
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <!-- Tambahkan atribut onchange untuk memanggil fungsi toggleStatusDropdown -->
        ...
        <!-- Dropdown Keterangan -->
        <!-- Pastikan elemen ini memiliki class "d-none" secara default -->
