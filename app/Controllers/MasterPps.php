...
class MasterPps extends BaseController
{
    ...
    {
        // Query untuk data MC Spec dengan JOIN ke master_table
    ...
    public function store()
    {
        ...
        // Simpan ke tabel master_table
        $saveMasterTable = $this->masterTableModel->save([
            'machine' => $post['machine'],
            'capacity' => $post['capacity'],
            'cushion' => $post['cushion'],
         
            'dh_dies' => $post['die_height'] // diasumsikan sama dengan dh_dies
        ]);
      
        // Cek apakah kedua penyimpanan berhasil
    ...
    public function update($id)
    {
        ...
        // Update master_table berdasarkan machine
