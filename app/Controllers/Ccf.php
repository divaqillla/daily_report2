...
{  
    ...
    public function create() 
    {
        ...
        $data['ccf_master_finishing_3'] = (new CcfMasterFinishing3Model()) // Mengganti ke model yang sesuai
        ->where('jenis', 'CCF')
            ->findAll();
    ...
    public function store()
    {
        ...
        // *** DEBUG tray: kita kumpulkan status tiap langkah
        $debug = [];
        ...
        $overviewData = [
            ...
            'status'        => 1,              // pastikan kolom status terisi
        ];
        ...
        // 14) Tampilkan semua debug info, lalu stop
        echo "<pre>" . implode("\n\n", $debug) . "</pre>";
    ...
    public function update($id)
    {
        ...
        try {
         ...
         // 8. Update Die Spot & Try
            ...
            $process2 = $this->request->getPost('die_spot_process');
            ...
            $process3 = $this->request->getPost('die_spot_process');
    ...
    public function generateExcel($id)
    {
        ...
        // gunakan model yang sudah di‑construct
        ...
        // ambil sheet OP10, ganti judul, dsb.
        ...
        if (!empty($overview['sketch'])) {
            ...
            if (file_exists($file)) {
                ...
                $drawing->setResizeProportional(false); // Jika ingin paksa sesuai ukuran
                $drawing->setWidthAndHeight(120, 110);    // Lebar dan tinggi gambar
                $drawing->setWorksheet($sheet);         // Terakhir
            }
        }
        ...
        foreach($mm as $d){
          $sheet->setCellValue("C{$r}", $no++)
          ->setCellValue("D{$r}", $d['mm_part_list'])
        ...
        // Die Spot1,2,3, ToolCost, Aksesoris — sama prinsipnya
        // =======================================================
