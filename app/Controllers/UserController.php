...
class UserController extends BaseController {
  ...
  public function updatePhoto()
    ...
    // Tambahkan method ini di dalam class UserController
public function downloadExcel() {
    // Pastikan PHPSpreadsheet sudah terinstal via composer dan autoload-nya diaktifkan
    ...
    // Siapkan writer untuk format Excel (Xlsx)
    $writer = new \PhpOffice\PhpSpreadsheet\Writer\Xlsx($spreadsheet);
    
    // Set header agar file bisa didownload oleh browser
